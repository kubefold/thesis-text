...
Przewidywanie konformacji białek to kluczowy problem biologii obliczeniowej~\cite{alphafold3}.
...
Krystalografia rentgenowska to podstawowa metoda doświadczalna określania struktury białek~\cite{xray_crystallography}.
...
Metody ab initio próbują przewidywać strukturę wyłącznie na podstawie sekwencji i praw fizyki~\cite{ab_initio_protein_folding}.
