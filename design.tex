...
\begin{figure}[htbp]
    ...
    \caption{Cluster resource archuitecture of ProteinDatabase}
...
\begin{figure}[htbp]
    ...
    \caption{Cluster resource archuitecture of ProteinConformationPrediction}
    \label{fig:proteinconformationprediction}
\end{figure}

%z kolei zasób \textit{ProteinConformationPrediction},
