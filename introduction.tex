...
Methodologically, the work follows an engineering, design-and-build approach: an analysis of the limitations of existing solutions informs the architecture, the system is implemented iteratively as a set of cooperating components, and its operation is validated empirically through an end-to-end deployment and measurement on a real Kubernetes cluster in the cloud.

The remainder of this thesis is organized as follows. Chapter~2 reviews the state of the art, covering protein structure prediction with AlphaFold, Kubernetes and cloud computing clusters, the operator pattern, and existing approaches to automating bioinformatics workflows. Chapter~3 presents the design and implementation of the KubeFold platform, including its custom resources and components. Chapter~4 describes the runtime environment and the experiments conducted on AWS. Chapter~5 discusses the obtained results, comparing KubeFold with manual and alternative approaches and analyzing performance, cost, and fault tolerance. Chapter~6 summarizes the work and outlines directions for further development.
