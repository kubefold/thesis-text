...
%TODO(matisiekpl): omów każdy plik

Plik \texttt{.cif} pozwala na zwizualizowanie struktury trójwymiarowej białka używając np. oprogramowania \textit{RCSB 3D View} (\url{https://www.rcsb.org/3d-view}).
