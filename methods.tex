...
The installation therefore comes down to executing a single command: \texttt{kubectl apply -f https://raw.githubusercontent.com/kubefold/operator/refs/heads/main/dist/install.yaml}.
...
The user can monitor the download progress in real-time, as shown in screenshot~\ref{fig:proteindatabase_terminal}.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/bucket2}
    \caption{Contents of bucket containing computation artifacts}
    \label{fig:bucket}
\end{figure}
