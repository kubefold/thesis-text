...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        ...
        \hline
        \textbf{Features}                           & \textbf{OpenFold}                         & \textbf{ColabFold}                & \textbf{KubeFold}                                      \\
        \hline
        \textbf{Platform}                           & HPC clusters, cloud (AWS, GCP)            & Google Colab, local environments & Kubernetes + AWS EKS \\
        \hline
        \textbf{Hardware requirements}              & High (e.g. GPU A100, RAM 64GB+)           & Low (free GPU in Colab) & Medium-high, dynamically scalable \\
        \hline
        ...
        \hline
        \textbf{Ease of deployment}                 & High difficulty (DevOps, ML)              & Very easy, suitable for beginners & Medium difficulty, requires basic Kubernetes knowledge \\
        \hline
