...
Abramson et al.
unveiled \textbf{AlphaFold 3 (AF3)}, a substantially updated model using a \textbf{diffusion-based architecture} to predict the \textbf{joint structure of complexes} including proteins, nucleic acids, small molecules, and ions~\cite{alphafold3}.
...
outward facing), with extreme conformations matching experimental structures (average TM-score $\approx$0.94).
...
\hline
\multicolumn{1}{|c|}{\textbf{Aspect}} & \multicolumn{1}{>{\centering\arraybackslash}p{5.5cm}|}{\textbf{Foldy}} & \multicolumn{1}{>{\centering\arraybackslash}p{5.5cm}|}{\textbf{KubeFold}} \\
\hline
\textbf{Installation} & 
...
A concise overview of the tools and their primary focus is provided in Table~\ref{tab:tools-focus}.

\begin{table}[htbp]
    \centering
    \caption{Tools and their primary focus}
    \label{tab:tools-focus}
    \small
    \begin{tabular}{|l|p{10cm}|}
        \hline
        \multicolumn{1}{|c|}{\textbf{Tool}} & \multicolumn{1}{>{\centering\arraybackslash}p{10cm}|}{\textbf{Primary focus}}                                                                                                                                                 \\
        \hline
        Nextflow      & Dataflow-based workflow orchestration; implicit parallelism; cloud and HPC executors; nf-core curated pipelines                                                        \\
        \hline
        Kubeflow      & Kubernetes-native MLOps platform; interactive notebooks, pipelines, hyperparameter tuning, and model serving                                                           \\
        \hline
        Foldy         & Web application for protein structure prediction and analysis (AlphaFold, docking); installation via Helm; autoscaling with Kubernetes Event-Driven Autoscaling (KEDA) \\
        \hline
        BioContainers & Community-maintained standardized containers for bioinformatics tools; reproducible packaging building blocks                                                          \\
        \hline
        KubeFold      & Operator-driven, declarative automation of infrastructure, data, and batch job lifecycle for protein structure prediction on Kubernetes                                \\
        \hline
    \end{tabular}
\end{table}
