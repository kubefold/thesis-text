...
\subsection{Pre-2021 Milestones}
...
\subsection{Advances in 2022–2023}
...
\subsubsection{Foldy: a web application for interactive protein structure analysis (2023)}

Roberts et al.
developed \textbf{Foldy}, an open-source \textbf{cloud-based platform} that makes advanced AI structural biology tools accessible to non-experts~\cite{Roberts2024Foldy}.
Foldy allows users to predict protein or complex structures (up to 6000 residues) with AlphaFold, visualize domain annotations, and perform ligand docking (via AutoDock Vina and DiffDock) through a simple web interface.
The system offers multiple deployment options (cloud or local) and an intuitive interface, enabling researchers to manage complex data and computational tasks easily.
It has been applied in case studies (e.g. enzyme design) and compared favorably to other tools, underscoring its practicality in day-to-day research.

\subsubsection{A Comprehensive Cloud Architecture for Machine Learning-enabled Research (2023)}

Packard et al.
proposed a cloud-based architecture composed of open-source software layers to support modern machine-learning workloads in research settings~\cite{Packard2023CloudML}.
The framework, presented at the PEARC 2024 conference, emphasizes portability and reproducibility of ML workflows on cloud and HPC resources.
By integrating scalable computing, data management, and container orchestration, this architecture demonstrates how complex ML-enabled research (such as large-scale model training and deployment) can be made more efficient and automated across institutional cloud clusters.

\subsection{Latest Developments (2024–2025)}
