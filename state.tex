...
%TODO 12.05 brakuje troche odsyłaczy do bibliografii
% Susgestie dotyczące bibliografii - szybki research

%Protein Structure Prediction Problem
%    AlphaFold2 Breakthrough: Jumper, J., et al. (2021). Highly accurate protein structure prediction with AlphaFold. Nature, 596(7873), 583–589.
%    Pre- and Post-AlphaFold2 Landscape: Baek, M., et al. (2021). Before and after AlphaFold2: An overview of protein structure prediction. Frontiers in Bioinformatics, 3, 1120370.
%    Deep Learning in Protein Structure Prediction: Senior, A. W., et al. (2020). Deep learning for protein structure prediction and design—progress and challenges. Nature Reviews Molecular Cell Biology, 22(3), 157–173.

%Encoding Three-Dimensional Protein Structure
%    Protein Folding and Structure: Dill, K. A., & MacCallum, J. L. (2012). The protein-folding problem, 50 years on. Science, 338(6110), 1042–1046.
%    Protein Structure Prediction via Deep Learning: Yang, J., et al. (2020). Protein structure prediction via deep learning: an in-depth review. Briefings in Bioinformatics, 22(3), 1–15.

%X-ray Crystallography
%    X-ray Protein Crystallography: Physics LibreTexts. (2022). X-ray Protein Crystallography.
%    Protein Structure Analysis and Validation: Berman, H. M., et al. (2000). Protein Structure Analysis and Validation with X-Ray Crystallography. Nucleic Acids Research, 28(1), 235–242.

%Computational Methods for Protein Structure Prediction
%    Ab Initio Protein Folding: Xu, D., & Zhang, Y. (2012). Ab initio protein structure assembly using continuous structure fragments and optimized knowledge-based force field. Proteins: Structure, Function, and Bioinformatics, 80(7), 1715–1735.
%    Advancements in Ab Initio Methods: Zhang, Y. (2008). I-TASSER server for protein 3D structure prediction. BMC Bioinformatics, 9, 40.

%AlphaFold by Google DeepMind
%    AlphaFold2 at CASP14: Tunyasuvunakool, K., et al. (2021). Applying and improving AlphaFold at CASP14. Proteins: Structure, Function, and Bioinformatics, 89(12), 1711–1721.
%    AlphaFold2 Overview: Jumper, J., et al. (2021). Highly accurate protein structure prediction with AlphaFold. Nature, 596(7873), 583–589.

%Computational Clusters in Cloud Environment
%    Kubernetes Operator Pattern: Kubernetes Documentation. (2023). Operator pattern.
%    Kubernetes Cluster Architecture: Kubernetes Documentation. (2023). Cluster Architecture.
%    Kubernetes Operators Explained: Red Hat. (2022). What is a Kubernetes Operator?. 
