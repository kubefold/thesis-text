...
AlphaFold operates in several distinct stages during protein structure prediction.
...
An example of Go's clean syntax is shown in listing~\ref{lst:go-example}.

\begin{lstlisting}[language=go,caption={Example Go code showing concurrency features},label={lst:go-example}]
package main
